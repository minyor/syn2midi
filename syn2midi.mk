...
$(IntermediateDirectory)/report.cpp$(ObjectSuffix): report.cpp $(IntermediateDirectory)/report.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "C:/Data/Workspace/Workspace/syn2midi/report.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/report.cpp$(ObjectSuffix) $(IncludePath)
